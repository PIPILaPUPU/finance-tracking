...
type AccountRepository interface {
	...
	UpdateSubAccount(context.Context, uuid.UUID, uuid.UUID, int64, string, *int) (model.Account, error)
...
func (r *PostgreAccountRepository) UpdateName(ctx context.Context, userID uuid.UUID, accountID uuid.UUID, req model.UpdateAccountName) (model.Account, error) {
...
func (r *PostgreAccountRepository) UpdateSubAccount(
	...
	row := r.pool.QueryRow(ctx, `
		...
		RETURNING `+accountColumns+`
	`, balance, allocationRule, percent, accountID, userID)
